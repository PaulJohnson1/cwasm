...
extern int cwasm_section_global_write(struct cwasm_section_global *, struct proto_bug *);
extern int cwasm_section_global_read(struct cwasm_section_global *, struct proto_bug *);
