...
int cwasm_section_function_write(struct cwasm_section_function *self, struct proto_bug *writer)
{
...
int cwasm_section_function_read(struct cwasm_section_function *self, struct proto_bug *reader)
{
