...
#define expression                                                             \
    do                                                                         \
    {                                                                          \
        int e = cwasm_instruction_read_vector(reader, &self->instructions,     \
...
#define table_index                                                            \
    ...
    {                                                                          \
        self->table_index =                                                    \
            proto_bug_read_varuint(reader, "element::table_index");            \
    } while (0)
...
#define reference_type                                                         \
    ...
    {                                                                          \
        self->type =                                                           \
            proto_bug_read_varuint(reader, "element::reference_type");         \
    } while (0)
