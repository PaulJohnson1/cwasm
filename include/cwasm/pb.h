...
#undef PROTO_BUG_NDEBUG
    ...
    void proto_bug_reset(struct proto_bug *);
    uint64_t proto_bug_get_size(struct proto_bug *);
    uint64_t proto_bug_get_total_size(struct proto_bug *);
    ...
    void proto_bug_write_varuint_debug(struct proto_bug *, uint64_t,
                                       char const *name, char const *file,
                                       uint32_t line);
    void proto_bug_write_varint32_debug(struct proto_bug *, int32_t,
                                        char const *name, char const *file,
                                        uint32_t line);
    void proto_bug_write_varint64_debug(struct proto_bug *, int64_t,
                                        char const *name, char const *file,
                                        uint32_t line);
    ...
    uint64_t proto_bug_read_varuint_debug(struct proto_bug *, char const *name,
                                          char const *file, uint32_t line);
    int32_t proto_bug_read_varint32_debug(struct proto_bug *, char const *name,
                                          char const *file, uint32_t line);
    int64_t proto_bug_read_varint64_debug(struct proto_bug *, char const *name,
                                          char const *file, uint32_t line);
...
#define proto_bug_write_varint32(this_pointer, value, name)                    \
    proto_bug_write_varint32_debug(this_pointer, value, name, __FILE__,        \
                                   __LINE__)
#define proto_bug_write_varint64(this_pointer, value, name)                    \
    proto_bug_write_varint64_debug(this_pointer, value, name, __FILE__,        \
                                   __LINE__)
...
#define proto_bug_read_varint32(this_pointer, name)                            \
    proto_bug_read_varint32_debug(this_pointer, name, __FILE__, __LINE__)
#define proto_bug_read_varint64(this_pointer, name)                            \
    proto_bug_read_varint64_debug(this_pointer, name, __FILE__, __LINE__)
...
#define proto_bug_write_varint32(this_pointer, value, name)                    \
    proto_bug_write_varint32_internal(this_pointer, value)
#define proto_bug_write_varint64(this_pointer, value, name)                    \
    proto_bug_write_varint64_internal(this_pointer, value)
#define proto_bug_write_float32(this_pointer, value, name)                     \
...
#define proto_bug_read_varint32(this_pointer, name)                            \
    proto_bug_read_varint32_internal(this_pointer)
#define proto_bug_read_varint64(this_pointer, name)                            \
    proto_bug_read_varint64_internal(this_pointer)
#define proto_bug_read_float32(this_pointer, name)                             \
